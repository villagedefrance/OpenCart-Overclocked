...
class ControllerModulePalette extends Controller {
    ...
    public function index() {
		...
		$this->data['text_manage_palettes'] = $this->language->get('text_manage_palettes');
		$this->data['text_manage_products'] = $this->language->get('text_manage_products');
		...
		$this->data['button_palette'] = $this->language->get('button_palette');
		...
		// Manager
		$this->data['manager_palette'] = $this->url->link('catalog/palette', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['manager_product'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'], 'SSL');
