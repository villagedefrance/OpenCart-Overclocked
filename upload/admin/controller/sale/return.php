...
class ControllerSaleReturn extends Controller { 
	...
	public function info() { 
		...
		if ($return_info) { 
			...
			$this->data['date_ordered'] = date($this->language->get('date_format_time'), strtotime($return_info['date_ordered'])); 
			...
			$this->data['date_added'] = date($this->language->get('date_format_time'), strtotime($return_info['date_added'])); 
			$this->data['date_modified'] = date($this->language->get('date_format_time'), strtotime($return_info['date_modified'])); 
			$this->data['product'] = $return_info['product']; 
			$this->data['model'] = $return_info['model']; 
			$this->data['quantity'] = $return_info['quantity']; 
