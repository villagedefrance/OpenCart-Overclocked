...
class ControllerSaleOfferCategoryProduct extends Controller {
	...
	protected function getList() {
		...
		$this->data['sort_name'] = HTTPS_SERVER . 'index.php?route=sale/offer_category_product&token=' . $this->session->data['token'] . '&sort=name' . $url;
		$this->data['sort_discount'] = HTTPS_SERVER . 'index.php?route=sale/offer_category_product&token=' . $this->session->data['token'] . '&sort=discount' . $url;
		$this->data['sort_type'] = HTTPS_SERVER . 'index.php?route=sale/offer_category_product&token=' . $this->session->data['token'] . '&sort=type' . $url;
		$this->data['sort_logged'] = HTTPS_SERVER . 'index.php?route=sale/offer_category_product&token=' . $this->session->data['token'] . '&sort=logged' . $url;
		$this->data['sort_date_start'] = HTTPS_SERVER . 'index.php?route=sale/offer_category_product&token=' . $this->session->data['token'] . '&sort=date_start' . $url;
		$this->data['sort_date_end'] = HTTPS_SERVER . 'index.php?route=sale/offer_category_product&token=' . $this->session->data['token'] . '&sort=date_end' . $url;
		$this->data['sort_status'] = HTTPS_SERVER . 'index.php?route=sale/offer_category_product&token=' . $this->session->data['token'] . '&sort=status' . $url;
		...
		$pagination->url = HTTPS_SERVER . 'index.php?route=sale/offer_category_product&token=' . $this->session->data['token'] . $url . '&page={page}';
