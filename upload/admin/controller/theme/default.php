...
class ControllerThemeDefault extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['default_viewer'])) {
			$this->data['default_viewer'] = $this->request->post['default_viewer'];
		} else {
			$this->data['default_viewer'] = $this->config->get('default_viewer');
		}
