...
class ControllerLocalisationStockStatus extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->post['apply'])) {
				$stock_status_id = $this->session->data['new_stock_status_id'];

				if ($stock_status_id) {
					unset($this->session->data['new_stock_status_id']);

					$this->redirect($this->url->link('localisation/stock_status/update', 'token=' . $this->session->data['token'] . '&stock_status_id=' . $stock_status_id . $url, 'SSL'));
				}
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->post['apply'])) {
				$stock_status_id = $this->request->get['stock_status_id'];
	...
	protected function getList() {
		...
		$this->data['sort_stock_status_id'] = $this->url->link('localisation/stock_status', 'token=' . $this->session->data['token'] . '&sort=stock_status_id' . $url, 'SSL');
