...
class ControllerLocalisationOrderStatus extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->post['apply'])) {
				$order_status_id = $this->session->data['new_order_status_id'];

				if ($order_status_id) {
					unset($this->session->data['new_order_status_id']);

					$this->redirect($this->url->link('localisation/order_status/update', 'token=' . $this->session->data['token'] . '&order_status_id=' . $order_status_id . $url, 'SSL'));
				}
	...
	protected function getList() {
		...
		$this->data['sort_order_status_id'] = $this->url->link('localisation/order_status', 'token=' . $this->session->data['token'] . '&sort=order_status_id' . $url, 'SSL');
