	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (isset($this->request->post['apply'])) {
				$this->redirect($this->url->link('payment/paypoint', 'token=' . $this->session->data['token'], 'SSL'));
			} else {
		...
		if (isset($this->request->post['paypoint_total_max'])) {
			$this->data['paypoint_total_max'] = $this->request->post['paypoint_total_max'];
		} else {
			$this->data['paypoint_total_max'] = $this->config->get('paypoint_total_max');
		}
