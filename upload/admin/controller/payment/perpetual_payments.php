	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (isset($this->request->post['apply'])) {
				$this->redirect($this->url->link('payment/perpetual_payments', 'token=' . $this->session->data['token'], 'SSL'));
			} else {
		...
		if (isset($this->request->post['perpetual_payments_total_max'])) {
			$this->data['perpetual_payments_total_max'] = $this->request->post['perpetual_payments_total_max'];
		} else {
			$this->data['perpetual_payments_total_max'] = $this->config->get('perpetual_payments_total_max');
		}
