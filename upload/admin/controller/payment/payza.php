	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (isset($this->request->post['apply'])) {
				$this->redirect($this->url->link('payment/payza', 'token=' . $this->session->data['token'], 'SSL'));
			} else {
		...
		if (isset($this->request->post['payza_total_max'])) {
			$this->data['payza_total_max'] = $this->request->post['payza_total_max'];
		} else {
			$this->data['payza_total_max'] = $this->config->get('payza_total_max');
		}
