...
// Link
$_['text_sagepay_direct']     = '<a onclick="window.open(\'https://support.sagepay.com/apply/default.aspx\');"><img src="view/image/payment/sagepay.png" alt="SagePay" title="SagePay" style="border:1px solid #EEEEEE;" /></a>';

// Text
$_['text_payment']            = 'Payment';
$_['text_success']            = 'Success: You have modified <b>Payment SagePay Direct</b> account details !';
