...
// Link
$_['text_klarna_invoice']   = '<a onclick="window.open(\'https://klarna.com/sell-with-klarna\');"><img src="view/image/payment/klarna.png" alt="Klarna Account" title="Klarna Account" style="border:1px solid #EEEEEE;" /></a>';

// Text
$_['text_payment']          = 'Payment';
$_['text_success']          = 'Success: You have modified <b>Klarna Invoice</b> account details !';
$_['text_live']             = 'Live';
$_['text_beta']             = 'Beta';
