...
$_['entry_mode']          = 'Logged-in State:<span class="help">Select which state to display when the customer is logged-in.</span>';
...
// Error
$_['error_permission']    = 'Warning: You do not have permission to modify module <b>Account</b> !';
?>
