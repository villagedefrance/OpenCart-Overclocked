...
$_['entry_pagination'] 					= 'Show Top Pagination:<br/><span class="help">If Yes, extra pagination links will be shown at the top of all lists.</span>';
$_['entry_autocomplete_category']	= 'Disable Category Auto-complete:<br/><span class="help">Overrides the default autocomplete in category form.</span>';
$_['entry_autocomplete_product']	= 'Disable Product Auto-complete:<br/><span class="help">Overrides the default autocomplete in product form.</span>';
