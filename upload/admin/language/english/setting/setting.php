...
$_['entry_empty_category']         = 'Allow Empty Categories:<span class="help">If Yes, the last level of empty categories will continue to appear in the store.</span>';
$_['entry_product_count']          = 'Allow Category Product Count:<span class="help">Show the number of products inside the subcategories in the category module.<br />Be warned, this will cause an extreme performance hit for stores with a lot of subcategories!</span>';
$_['entry_coupon_special']         = 'Allow Special Coupons:<span class="help">Allow Coupons to be applied to products on a Special offer.</span>';
...
$_['entry_login_attempts']         = 'Maximum Login Attempts:<span class="help">Maximum login attempts allowed before the account is locked for 1 hour. Affiliate accounts can be unlocked on the affiliate admin page.</span>';
...
$_['entry_affiliate_activity']     = 'Affiliate Activity:<span class="help">Monitor and Log affiliate activity.</span>';
...
$_['entry_admin_width_limit']      = 'Administration Width Limit:<span class="help">Fixes Administration screen width at 1440px for large resolution monitors. Note: If selected, the page will no longer be responsive.</span>';
