...
$_['entry_our_location']				= 'Hide Store Location:<span class="help">Remove "Our Location" block from the Contact and Quotation pages.</span>';
$_['entry_location'] 						= 'Enter/Select Address:<span class="help">Auto-completed as you type.</span>';
...
$_['entry_contact_map'] 				= 'Display Contact Map:<span class="help">Show Google Map and coordinates on Contact page.</span>';
...
$_['entry_secure']						= 'Use SSL:<span class="help">To use SSL check with your host if a SSL certificate is installed and added the SSL URL to the catalog and admin config files.</span>';
