...
$_['entry_express_phone'] 			= 'Customer\'s Telephone:';
...
$_['entry_seo_url']              			= 'Use SEO URLs:<br /><span class="help">To use SEO URLs apache module mod-rewrite must be installed. If Yes is selected, the "htaccess.txt" file will be automatically converted to ".htaccess".<br /><b>Note:</b>You must "apply/save" twice for the conversion to succeed.</span>';
