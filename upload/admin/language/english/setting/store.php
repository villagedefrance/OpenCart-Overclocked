...
$_['entry_ssl']                    			= 'SSL URL:<span class="help">SSL URL to your store. Make sure to add \'/\' at the end. Example: https://www.yourdomain.com/path/<br /><br />Don\'t use directories to create a new store. You should always point another domain or sub domain to your hosting.</span>';
