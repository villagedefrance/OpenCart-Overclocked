<?php
// Heading  
$_['heading_title']       			= 'Category to Product';

// Text
$_['text_success']        		= 'Success: You have modified <b>Category to Product</b> !';
...
$_['entry_category_one']		= 'Category:<br /><span class="help">Select a reference category.</span>';
$_['entry_product_two']		= 'Product:<br /><span class="help">Select the product the offer will apply to.</span>';
...
// Error
$_['error_permission']    		= 'Warning: You do not have permission to modify <b>Category to Product</b> !';
$_['error_name']          		= 'Offer Name must be between 3 and 128 characters!';
$_['error_percent']          		= 'Percent Discount can not be more than 100%!';
