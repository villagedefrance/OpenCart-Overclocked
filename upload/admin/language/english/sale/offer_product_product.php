...
$_['entry_product_one'] = 'Product 1:<span class="help">Select a reference product.</span>';
$_['entry_product_two'] = 'Product 2:<span class="help">Select the product the offer will apply to.</span>';
