...
$_['error_opencart_xml']               = 'Required file "<span class="error-install">/vqmod/xml/vqmod_opencart.xml</span>" does not appear to exist! <br />Please install the latest OpenCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a> and try again.';
...
$_['error_opencart_xml_version']       = 'You appear to be using a version of "<span class="error-install">vqmod_opencart.xml</span>" that is out-of-date for your OpenCart version! <br />Please install the latest OpenCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a> and try again.';
$_['error_vqcache_dir']                = 'Required directory "<span class="error-install">/vqmod/vqcache</span>" does not appear to exist! <br /><br />Please install the latest OpenCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a>';
...
$_['error_vqmod_core']                 = 'Required file "<span class="error-install">vqmod.php</span>" is missing! <br />Please install the latest OpenCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a> and try again.';
$_['error_vqmod_dir']                  = 'The "<span class="error-install">/vqmod</span>" directory does not appear to exist!';
$_['error_vqmod_install_link']         = '<b>VQMod&#8482; does not appear to have been integrated with OpenCart!</b> <br /><br />Please run the VQmod installer: <a href="%1$s" class="button-repair">INSTALL</a><br />';
$_['error_vqmod_opencart_integration'] = '<b>VQMod&#8482; does not appear to have been integrated with OpenCart!</b> <br /><br />Please install the latest OpenCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a> and try again.';
$_['error_vqmod_script_dir']           = 'Required directory "<span class="error-install">/vqmod/xml</span>" does not appear to exist! <br />Please install the latest OpenCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a> and try again.';
...
// Variable Settings
$_['setting_cachetime']                = 'cacheTime:<span class="help">Deprecated as of VQMod&#8482; 2.2.0</span>';
$_['setting_dir_separator']            = 'Directory Separator:';
$_['setting_logfolder']                = 'Log Folder:<span class="help">VQMod&#8482; 2.2.0 and later</span>';
$_['setting_logging']                  = 'Error Logging:';
$_['setting_modcache']                 = 'modCache:';
$_['setting_path_replaces']            = 'Path Replacements:<span class="help">Changes do not go into effect until the mods.cache file is deleted.</span>';
$_['setting_protected_files']          = 'Protected Files:';
$_['setting_usecache']                 = 'useCache:<span class="help">Deprecated as of VQMod&#8482; 2.1.7</span>';
...
$_['text_autodetect_fail']             = 'Unable to detect VQMod&#8482; installation. <br />Please download and install the <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest version</a> or enter the non-standard server installation path.';
...
$_['vqmods_version']                   = '2.1.1 - Overclocked Edition';
