...
// Link
$_['text_firstdata']                 = '<a onclick="window.open(\'https://www.firstdata.com/ecommerce/\');"><img src="view/image/payment/firstdata.png" alt="First Data" title="First Data" style="border:1px solid #EEEEEE;" /></a>';

// Text
$_['text_payment']                   = 'Payment';
$_['text_success']                   = 'Success: You have modified <b>Payment First Data</b>!';
