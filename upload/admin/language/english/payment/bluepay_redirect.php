...
// Link
$_['text_bluepay_redirect']  = '<a onclick="window.open(\'http://www.bluepay.com/\');"><img src="view/image/payment/bluepay.png" alt="BluePay Redirect" title="BluePay Redirect" style="border:1px solid #EEEEEE;" /></a>';

// Text
$_['text_payment']           = 'Payment';
$_['text_success']           = 'Success: You have modified <b>BluePay Redirect</b> account details!';
