...
// Link
$_['text_pp_pro']        = '<a onclick="window.open(\'https://www.paypal.com/\');"><img src="view/image/payment/paypal.png" alt="PayPal Website Payment Pro" title="PayPal Website Payment Pro" style="border:1px solid #EEEEEE;" /></a>';

// Text 
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified <b>Payment PayPal Website Payment Pro</b> account details !';
...
// Error
$_['error_permission']   = 'Warning: You do not have permission to modify <b>Payment PayPal Website Payment Pro</b> !';
