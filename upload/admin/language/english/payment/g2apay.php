...
// Link
$_['text_g2apay']                     = '<a onclick="window.open(\'https://pay.g2a.com/\');"><img src="view/image/payment/g2apay.png" alt="G2APay" title="G2APay" style="border:1px solid #EEEEEE;" /></a>';

// Text
$_['text_payment']                    = 'Payment';
$_['text_success']                    = 'Success: You have modified <b>G2APay</b> account details.';
...
$_['error_username']                  = 'User name required!';
