...
$_['text_success']                   = 'Success: You have modified payment <b>Paypal Payflow Pro iFrame</b> account details !';
...
$_['entry_silent_post_url']          = 'Silent POST URL (Public URL to send your transaction results to):';

$_['entry_test']                     = 'Test mode:';
$_['entry_debug']                    = 'Debug mode:';
$_['entry_transaction_method']       = 'Transaction method:';
$_['entry_checkout_method']          = 'Checkout method:';
$_['entry_timeout']                  = 'Timeout:';
...
$_['help_username']                  = 'If you set up one or more additional users on the account, this value is the ID of the user authorised to process transactions. If, however, you have not set up additional users on the account, USER has the same value as VENDOR.';
...
// Button
$_['button_pp_manager']              = 'PayPal Manager';

// Error
$_['error_permission']               = 'Warning: You do not have permission to modify payment <b>Paypal Payflow Pro iFrame</b> !';
