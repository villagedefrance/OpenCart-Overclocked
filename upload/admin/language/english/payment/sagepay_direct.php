...
// Link
$_['text_sagepay_direct']	= '<a onclick="window.open(\'http://www.sagepay.co.uk/\');"><img src="view/image/payment/sagepay.png" alt="SagePay" title="SagePay" style="border:1px solid #EEEEEE;" /></a>';
