...
// Link
$_['text_pp_pro_iframe']               = '<a onclick="window.open(\'https://www.paypal.com/\');"><img src="view/image/payment/paypal.png" alt="PayPal Website Payment Pro" title="PayPal Website Payment Pro iFrame" style="border:1px solid #EEEEEE;" /></a>';
...
// Help
$_['help_user']                        = 'API username (this is not usually your PayPal email, it is created for you when you request API access)';
$_['help_password']                    = 'API password (NOT your PayPal password)';
$_['help_signature']                   = 'API signature key';
...
$_['error_parent_transaction_missing'] = 'Could not find the parent transaction!';
