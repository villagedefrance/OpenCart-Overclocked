...
$_['entry_age_minimum']		= 'Minimum Age:<br /><span class="help">Minimum age a customer must be to be able to purchase this product. Enter 0 if no minimum.</span>';
...
$_['entry_store_location']		= 'Stock Locations:<br /><span class="help">Select locations where the product is currently In stock</span>';
...
$_['entry_location']         		= 'Location:<br /><span class="help">(Optional)</span>';
