...
"combine",function(){var b=Array.prototype.slice.call(arguments,0);return function(c,a){for(var f=0;f<b.length;++f){var q=b[f](c,a);if(q)return q}}});a.registerHelper("fold","auto",function(b,c){for(var a=b.getHelpers(c,"fold"),f=0;f<a.length;f++){var q=a[f](b,c);if(q)return q}});var c={rangeFinder:a.fold.auto,widget:"↔",minFoldSize:0,scanUp:!1,clearOnEnter:!0};a.defineOption("foldOptions",null);a.defineExtension("foldOption",function(b,c){return f(this,b,c)})});
