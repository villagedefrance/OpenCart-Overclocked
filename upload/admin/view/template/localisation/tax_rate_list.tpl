		...
		<table class="list">
          <thead>
			<tr>
				...
				<?php } else { ?>
					<a href="<?php echo $sort_rate; ?>"><?php echo $column_rate; ?>&nbsp;&nbsp;<img src="view/image/asc.png" alt="" /></a>
				<?php } ?></td>
				...
				<?php } else { ?>
					<a href="<?php echo $sort_geo_zone; ?>"><?php echo $column_geo_zone; ?>&nbsp;&nbsp;<img src="view/image/asc.png" alt="" /></a>
				<?php } ?></td> 
