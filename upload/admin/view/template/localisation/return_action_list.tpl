        ...
        <?php if ($return_actions) { ?>
          ...
          <tr>
            <td style="text-align:center;"><?php if ($return_action['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $return_action['return_action_id']; ?>" id="<?php echo $return_action['return_action_id']; ?>" class="checkbox" checked />
              <label for="<?php echo $return_action['return_action_id']; ?>"><span></span></label>
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $return_action['return_action_id']; ?>" id="<?php echo $return_action['return_action_id']; ?>" class="checkbox" />
              <label for="<?php echo $return_action['return_action_id']; ?>"><span></span></label>
            <?php } ?></td>
