        ...
        <tr>
          ...
          <td><?php foreach ($languages as $language) { ?>
            <?php if (isset($error_title[$language['language_id']])) { ?>
              <input type="text" name="length_class_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($length_class_description[$language['language_id']]) ? $length_class_description[$language['language_id']]['title'] : ''; ?>" class="input-error" />
        ...
        <tr>
          ...
          <td><?php foreach ($languages as $language) { ?>
            <?php if (isset($error_unit[$language['language_id']])) { ?>
              <input type="text" name="length_class_description[<?php echo $language['language_id']; ?>][unit]" value="<?php echo isset($length_class_description[$language['language_id']]) ? $length_class_description[$language['language_id']]['unit'] : ''; ?>" class="input-error" />
              <img src="view/image/flags/<?php echo $language['image']; ?>" alt="" title="<?php echo $language['name']; ?>" /><br />
