      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <thead>
          <tr>
            ...
            <?php } else { ?>
              <a href="<?php echo $sort_description; ?>"><?php echo $column_description; ?>&nbsp;&nbsp;<img src="view/image/sort.png" alt="" /></a>
            <?php } ?></td>
        ...
        <?php if ($geo_zones) { ?>
          ...
          <tr>
            <td style="text-align:center;"><?php if ($geo_zone['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $geo_zone['geo_zone_id']; ?>" id="<?php echo $geo_zone['geo_zone_id']; ?>" class="checkbox" checked />
              <label for="<?php echo $geo_zone['geo_zone_id']; ?>"><span></span></label>
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $geo_zone['geo_zone_id']; ?>" id="<?php echo $geo_zone['geo_zone_id']; ?>" class="checkbox" />
              <label for="<?php echo $geo_zone['geo_zone_id']; ?>"><span></span></label>
            <?php } ?></td>
