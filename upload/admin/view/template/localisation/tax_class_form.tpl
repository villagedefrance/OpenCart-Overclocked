        ...
        <table id="tax-rule" class="list">
          ...
          <tbody id="tax-rule-row<?php echo $tax_rule_row; ?>">
            <tr>
              ...
              <td class="center"><a onclick="$('#tax-rule-row<?php echo $tax_rule_row; ?>').remove();" class="button-delete ripple"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $tax_rule_row++; ?>
          <?php } ?>
          <tfoot>
            <tr>
              <td colspan="3"></td>
              <td class="center"><a onclick="addRule();" class="button ripple"><?php echo $button_add_rule; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
function addRule() {
	...
	html += '    <td class="center"><a onclick="$(\'#tax-rule-row' + tax_rule_row + '\').remove();" class="button-delete ripple"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
