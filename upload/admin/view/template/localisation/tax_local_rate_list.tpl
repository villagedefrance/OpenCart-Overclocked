      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <thead>
          <tr>
            ...
            <?php } ?></td>
            <td class="left"><?php if ($sort == 'rate') { ?>
        ...
        <tbody>
        <?php if ($tax_local_rates) { ?>
          <?php foreach ($tax_local_rates as $tax_local_rate) { ?>
          <tr>
            <td style="text-align:center;"><?php if ($tax_local_rate['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $tax_local_rate['tax_local_rate_id']; ?>" id="<?php echo $tax_local_rate['tax_local_rate_id']; ?>" class="checkbox" checked />
              <label for="<?php echo $tax_local_rate['tax_local_rate_id']; ?>"><span></span></label>
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $tax_local_rate['tax_local_rate_id']; ?>" id="<?php echo $tax_local_rate['tax_local_rate_id']; ?>" class="checkbox" />
              <label for="<?php echo $tax_local_rate['tax_local_rate_id']; ?>"><span></span></label>
            <?php } ?></td>
            <td class="left"><?php echo $tax_local_rate['name']; ?></td>
            <td class="right"><?php echo $tax_local_rate['rate']; ?> %</td>
            <?php if ($tax_local_rate['status'] == 1) { ?>
