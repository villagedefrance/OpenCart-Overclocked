        ...
        <tr>
          ...
          <td><?php foreach ($languages as $language) { ?>
            <?php if (isset($error_name[$language['language_id']])) { ?>
              <input type="text" name="return_action[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($return_action[$language['language_id']]) ? $return_action[$language['language_id']]['name'] : ''; ?>" class="input-error" />
