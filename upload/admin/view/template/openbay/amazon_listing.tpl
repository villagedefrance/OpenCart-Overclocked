...
<div id="content">
    ...
    <div class="box mBottom130">
      <div class="heading">
        ...
        <div class="buttons">
          <a onclick="location = '<?php echo $url_return; ?>';" class="button"><?php echo $button_return; ?></a>
        </div>
      </div>
      <div class="content">
            ...
            <div id="required-info">
              ...
              <?php if (!empty($options)) { ?>
                <tr>
                  ...
                  <td><select id="openstock_selector" name="option_variant">
              ...
              <?php }?>
                ...
                <tr>
                  ...
                  <td><select name="condition" id="condition" class="width200">
            ...
            <div id="additional-info">
              <table class="form">
                <tr>
                  ...
                  <td><textarea cols="70" rows="15" name="condition_note" id="condition_note" placeholder="<?php echo $lang_placeholder_condition; ?>"></textarea></td>
                </tr>
                <tr>
...
function getProduct(asin) {
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.img != '') {
                html += '<img style="float:left;" src="' + data.img + '" alt="" />';
            }
