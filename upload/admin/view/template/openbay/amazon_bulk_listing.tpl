      ...
      <form action="" method="post" enctype="multipart/form-data" id="product-form">
        ...
        <table class="list">
          ...
          <tr>
            ...
            <td class="left"><input type="text" name="condition_note" style="width:98%" /></td>
          </tr>
          <tr>
            <td class="left"><?php echo $text_start_selling; ?></td>
            <td class="left"><input type="text" name="start_selling" class="date" /></td>
            <td colspan="2"></td>
          </tr>
          </tbody>
        </table>
        <table class="list">
          ...
          <tr>
            ...
            <td class="center"><img src="<?php echo $product['image']; ?>" alt="" /></td>
            ...
            <td class="left" id="result-<?php echo $product['product_id']; ?>">
              <?php if ($product['matches'] !== null) { ?><?php $checked = false; ?>
              <?php if ($product['matches'] > 0) { ?>
                ...
                <br/>
                <?php foreach ($product['search_results'] as $search_result) { ?><?php if (!$checked) { ?>
                ...
                <?php } else { ?>
                  ...
                  <a target="_blank" href="<?php echo $search_result['href']; ?>"><?php echo $search_result['title']; ?></a>
                  <br/>
                  <?php } ?>
                <?php } else { ?>
                  <input class="amazon-listing" checked="checked" type="radio" name="products[<?php echo $product['product_id']; ?>]" value="" />
                  <?php echo $text_dont_list; ?>
                  <br/>
                <?php } ?>
              <?php } ?>
            </td>
