            ...
            <?php foreach ($orders as $order) { ?>
              ...
              <tr>
                ...
                <?php if ($order['channel'] == 'eBay') { ?>
                  <?php if ($this->request->post['change_order_status_id'] == $this->config->get('EBAY_DEF_SHIPPED_ID')) { ?>
                    <p>
                ...
                <?php if ($order['channel'] == 'Amazon EU') { ?>
                  <?php if ($this->request->post['change_order_status_id'] == $this->config->get('openbay_amazon_order_status_shipped')) { ?>
                    <p>
                      <span style="display:block; width:80px; font-weight:bold;"><?php echo $lang_carrier; ?>:</span>
                ...
                <?php if ($order['channel'] == 'Amazon US') { ?>
                  <?php if ($this->request->post['change_order_status_id'] == $this->config->get('openbay_amazonus_order_status_shipped')) { ?>
                     <p>
                       <span style="display:block; width:80px; font-weight:bold;"><?php echo $lang_carrier; ?>:</span>
