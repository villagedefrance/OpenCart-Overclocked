                        ...
                        <tr>
                            ...
                            <td>
                                <select name="EBAY_DEF_IMPORT_ID" style="width:200px;">
                                    <?php if (empty($EBAY_DEF_IMPORT_ID)) {
                                      $EBAY_DEF_IMPORT_ID = 1;
                                    }

                                    foreach ($order_statuses as $status) {
                                      echo '<option value="' . $status['order_status_id'] . '"';
                                      if ($EBAY_DEF_IMPORT_ID == $status['order_status_id']) {
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="EBAY_DEF_PAID_ID" style="width:200px;">
                                    <?php if (empty($EBAY_DEF_PAID_ID)) {
                                      $EBAY_DEF_PAID_ID = 2;
                                    }

                                    foreach ($order_statuses as $status) {
                                      echo '<option value="' . $status['order_status_id'] . '"';
                                      if ($EBAY_DEF_PAID_ID == $status['order_status_id']) {
                                        echo ' selected=selected';
                                      }
                                      echo'>' . $status['name'] . '</option>';
                                    } ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="EBAY_DEF_SHIPPED_ID" style="width:200px;">
                                    <?php if (empty($EBAY_DEF_SHIPPED_ID)) {
                                      $EBAY_DEF_SHIPPED_ID = 3;
                                    }

                                    foreach ($order_statuses as $status) {
                                      echo '<option value="' . $status['order_status_id'] . '"';
                                      if ($EBAY_DEF_SHIPPED_ID == $status['order_status_id']) {
                                        echo ' selected=selected';
                                      }
                                      echo'>' . $status['name'] . '</option>';
                                    } ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="EBAY_DEF_CANCELLED_ID" style="width:200px;">
                                    <?php if (empty($EBAY_DEF_CANCELLED_ID)) {
                                      $EBAY_DEF_CANCELLED_ID = 7;
                                    }

                                    foreach ($order_statuses as $status) {
                                      echo '<option value="' . $status['order_status_id'] . '"';
                                      if ($EBAY_DEF_CANCELLED_ID == $status['order_status_id']) {
                                        echo ' selected=selected';
                                      }
                                      echo'>' . $status['name'] . '</option>';
                                    } ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="EBAY_DEF_PARTIAL_REFUND_ID" style="width:200px;">
                                    <?php if (empty($EBAY_DEF_PARTIAL_REFUND_ID)) {
                                      $EBAY_DEF_PARTIAL_REFUND_ID = 2;
                                    }

                                    foreach ($order_statuses as $status) {
                                      echo '<option value="' . $status['order_status_id'] . '"';
                                      if ($EBAY_DEF_PARTIAL_REFUND_ID == $status['order_status_id']) {
                                        echo ' selected=selected';
                                      }
                                      echo'>' . $status['name'] . '</option>';
                                    } ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="EBAY_DEF_REFUNDED_ID" style="width:200px;">
                                    <?php if (empty($EBAY_DEF_REFUNDED_ID)) {
                                      $EBAY_DEF_REFUNDED_ID = 11;
                                    }

                                    foreach ($order_statuses as $status) {
                                      echo '<option value="' . $status['order_status_id'] . '"';
                                      if ($EBAY_DEF_REFUNDED_ID == $status['order_status_id']) {
                                        echo ' selected=selected';
                                      }
                                      echo'>' . $status['name'] . '</option>';
                                    } ?>
