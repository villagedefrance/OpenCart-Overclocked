        ...
        <div id="v2-update-tab">
          ...
          <table class="form">
            ...
            <tr class="update-v2-box">
              ...
              <td><a class="button" id="update-v2"><?php echo $lang_btn_update; ?></a></td>
            </tr>
            <tr id="update-v2-progress" style="display:none;">
              <td valign="middle"><?php echo $text_progress; ?></td>
              <td><span id="v2-update-percent"></span> / <span id="v2-update-text"></span></td>
            </tr>
          </table>
        </div>
      ...
      <div id="tab-settings">
        <table class="form">
          <tr>
            ...
            <td><select name="openbay_language">
