          ...
          <table class="form">
            ...
            <tr>
              ...
              <?php } else { ?>
                <input type="radio" name="geozone_method" value="item" /><?php echo $text_item; ?>
                <input type="radio" name="geozone_method" value="weight" /><?php echo $text_weight; ?>
                <input type="radio" name="geozone_method" value="price" checked="checked" /><?php echo $text_price; ?>
              <?php } ?></td>
            </tr>
            <tr>
        ...
        <div id="tab-geo-zone<?php echo $geo_zone['geo_zone_id']; ?>" class="vtabs-content">
          <table class="form">
            <tr>
              ...
              <td><textarea name="geozone_<?php echo $geo_zone['geo_zone_id']; ?>_rate" cols="40" rows="5"><?php echo ${'geozone_' . $geo_zone['geo_zone_id'] . '_rate'}; ?></textarea></td>
            </tr>
            <tr>
              <td><?php echo $entry_status; ?></td>
              <td><select name="geozone_<?php echo $geo_zone['geo_zone_id']; ?>_status">
                <?php if (${'geozone_' . $geo_zone['geo_zone_id'] . '_status'}) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
