          ...
          <div id="tab-geo-zone<?php echo $geo_zone['geo_zone_id']; ?>" class="vtabs-content">
            <table class="form">
              <tr>
                ...
                <td><textarea name="price_<?php echo $geo_zone['geo_zone_id']; ?>_rate" cols="40" rows="5"><?php echo ${'price_' . $geo_zone['geo_zone_id'] . '_rate'}; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_status; ?></td>
                <td><select name="price_<?php echo $geo_zone['geo_zone_id']; ?>_status">
                  <?php if (${'price_' . $geo_zone['geo_zone_id'] . '_status'}) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                    <option value="1"><?php echo $text_enabled; ?></option>
