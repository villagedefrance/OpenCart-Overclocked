...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="flat_1">
        <table class="form">
          <tr>
            <td><?php echo $entry_cost; ?></td>
            <td><input type="text" name="flat_1_cost" value="<?php echo $flat_1_cost; ?>" /></td>
          </tr>
          <tr>
