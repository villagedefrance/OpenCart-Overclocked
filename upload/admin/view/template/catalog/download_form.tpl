	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<table class="form">
          ...
          <tr>
			...
			<td><input type="text" name="filename" value="<?php echo $filename; ?>" size="30" /> <a id="button-upload" class="button"><?php echo $button_upload; ?></a>
          ...
          <tr>
			...
			<td><input type="text" name="mask" value="<?php echo $mask; ?>" size="30" />
			<?php if ($error_mask) { ?>
