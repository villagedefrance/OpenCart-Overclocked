...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
        <a onclick="location='<?php echo $news_list; ?>';" class="button-cancel ripple"><i class="fa fa-arrow-left"></i> &nbsp; <?php echo $button_news; ?></a>
    ...
    <?php } ?>
    <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form" name="newsdownload">
      <table class="list">
        <thead>
          <tr>
