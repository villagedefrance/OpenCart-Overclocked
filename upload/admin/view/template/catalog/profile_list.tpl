...
<div id="content">
  ...
  <div class="box">
    ...
    <?php } ?>
    <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form" name="profile">
      <table class="list">
        <thead>
          <tr>        
        ...
        <?php if ($profiles) { ?>
          ...
          <tr>
            ...
            <td class="right"><?php foreach ($profile['action'] as $action) { ?>
              <a href="<?php echo $action['href'] ?>" class="button-form animated fadeIn ripple"><?php echo $action['name']; ?></a>
            <?php } ?></td>
          </tr>
          <?php } ?>
        <?php } else { ?>
