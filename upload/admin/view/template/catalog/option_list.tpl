          ...
          <?php foreach ($options as $option) { ?>
            <tr>
              <td style="text-align:center;"><?php if ($option['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $option['option_id']; ?>" id="<?php echo $option['option_id']; ?>" class="checkbox" checked />
                <label for="<?php echo $option['option_id']; ?>"><span></span></label>
              <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $option['option_id']; ?>" id="<?php echo $option['option_id']; ?>" class="checkbox" />
                <label for="<?php echo $option['option_id']; ?>"><span></span></label>
              <?php } ?></td>
