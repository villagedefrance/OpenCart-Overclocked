...
<div id="content">
  ...
  <div class="box">
    ...
    <?php } ?>
    <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form" name="filter">
      <table class="list">
        <thead>
        <tr>
          ...
          <?php } else { ?>
            <a href="<?php echo $sort_name; ?>"><?php echo $column_group; ?>&nbsp;&nbsp;<img src="view/image/sort.png" alt="" /></a>
          <?php } ?></td>
          <td class="left"><?php if ($sort == 'fg.sort_order') { ?>
          ...
          <?php foreach ($filters as $filter) { ?>
            <tr>
              <td style="text-align:center;"><?php if ($filter['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $filter['filter_group_id']; ?>" id="<?php echo $filter['filter_group_id']; ?>" class="checkbox" checked />
                <label for="<?php echo $filter['filter_group_id']; ?>"><span></span></label>
              <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $filter['filter_group_id']; ?>" id="<?php echo $filter['filter_group_id']; ?>" class="checkbox" />
                <label for="<?php echo $filter['filter_group_id']; ?>"><span></span></label>
              <?php } ?></td>
              <td class="left"><?php echo $filter['name']; ?></td>
              <td class="center"><?php echo $filter['sort_order']; ?></td>
