...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
        <a onclick="location = '<?php echo $module_horizontal; ?>';" class="button-cancel ripple"><?php echo $button_horizontal; ?></a>
        <a onclick="location = '<?php echo $module_vertical; ?>';" class="button-cancel ripple"><?php echo $button_vertical; ?></a>
