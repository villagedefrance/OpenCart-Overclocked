    ...
    <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <thead>
        <tr>
          ...
          <?php } else { ?>
            <a href="<?php echo $sort_location; ?>"><?php echo $column_location; ?>&nbsp;&nbsp;<img src="view/image/sort.png" alt="" /></a>
          <?php } ?></td>
      ...
      <?php if ($custom_fields) { ?>
        ...
        <tr>
          <td style="text-align:center;"><?php if ($custom_field['selected']) { ?>
            <input type="checkbox" name="selected[]" value="<?php echo $custom_field['custom_field_id']; ?>" id="<?php echo $custom_field['custom_field_id']; ?>" class="checkbox" checked />
            <label for="<?php echo $custom_field['custom_field_id']; ?>"><span></span></label>
          <?php } else { ?>
            <input type="checkbox" name="selected[]" value="<?php echo $custom_field['custom_field_id']; ?>" id="<?php echo $custom_field['custom_field_id']; ?>" class="checkbox" />
            <label for="<?php echo $custom_field['custom_field_id']; ?>"><span></span></label>
          <?php } ?></td>
