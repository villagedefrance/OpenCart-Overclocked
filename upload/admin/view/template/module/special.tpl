	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="special">
		<table class="form">
			<tr> 
				...
				<td>
					<?php if ($special_theme) { ?>
						<?php echo $text_yes; ?><input type="radio" name="special_theme" value="1" checked="checked" />
						<?php echo $text_no; ?><input type="radio" name="special_theme" value="0" />
					<?php } else { ?>
						<?php echo $text_yes; ?><input type="radio" name="special_theme" value="1" />
						<?php echo $text_no; ?><input type="radio" name="special_theme" value="0" checked="checked" />
					<?php } ?>
				</td>
			</tr>
			...
			<tr style="background:#F8F8F8;">
				...
				<td> 
					<?php if($special_viewproduct) { ?>
						<?php echo $text_yes; ?><input type="radio" name="special_viewproduct" value="1" checked="checked" />
						<?php echo $text_no; ?><input type="radio" name="special_viewproduct" value="0" />
					<?php } else { ?>
						<?php echo $text_yes; ?><input type="radio" name="special_viewproduct" value="1" />
						<?php echo $text_no; ?><input type="radio" name="special_viewproduct" value="0" checked="checked" />
					<?php } ?>
				</td> 
			</tr>
			<tr style="background:#F8F8F8;">
				...
				<td> 
					<?php if($special_addproduct) { ?>
						<?php echo $text_yes; ?><input type="radio" name="special_addproduct" value="1" checked="checked" />
						<?php echo $text_no; ?><input type="radio" name="special_addproduct" value="0" />
					<?php } else { ?>
						<?php echo $text_yes; ?><input type="radio" name="special_addproduct" value="1" />
						<?php echo $text_no; ?><input type="radio" name="special_addproduct" value="0" checked="checked" />
					<?php } ?>
				</td> 
			</tr>
		</table>
...
function addModule() {
	...
	html += '    	<td class="left">';
	html += '			<input type="text" name="special_module[' + module_row + '][image_width]" value="100" size="3" /> x ';
	html += '    		<input type="text" name="special_module[' + module_row + '][image_height]" value="100" size="3" /> px';
	html += '    	</td>';
