...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="hangouts">
        <table class="form">
        <tbody>
          <tr>
            <td><?php echo $entry_theme; ?></td>
            <td><?php if ($google_hangouts_theme) { ?>
              <input type="radio" name="google_hangouts_theme" value="1" id="theme-on" class="radio" checked />
              <label for="theme-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="google_hangouts_theme" value="0" id="theme-off" class="radio" />
              <label for="theme-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } else { ?>
              <input type="radio" name="google_hangouts_theme" value="1" id="theme-on" class="radio" />
              <label for="theme-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="google_hangouts_theme" value="0" id="theme-off" class="radio" checked />
              <label for="theme-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><textarea name="google_hangouts_code" cols="80" rows="5"><?php echo $google_hangouts_code; ?></textarea>
              <?php if ($error_code) { ?>
        ...
        <?php foreach ($modules as $module) { ?>
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="left"><select name="google_hangouts_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td class="center">
                <input type="text" name="google_hangouts_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" />
              </td>
              <td class="center">
...
function addModule() {
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="google_hangouts_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '    </select></td>';
	html += '    <td class="center"><input type="text" name="google_hangouts_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
