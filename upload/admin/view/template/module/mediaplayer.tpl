      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="mediaplayer">
        ...
        <tbody id="header-1" class="module-header">
          ...
          <?php echo $stylesheet_mode ? '<tr style="display:none;">' : '<tr style="background:#FCFCFC;">'; ?>
            ...
            <td><select name="mediaplayer_header_color">
              <?php foreach ($skins as $skin) { ?>
                <?php if ($skin['skin'] == $mediaplayer_header_color) { ?>
          ...
          <?php echo $stylesheet_mode ? '<tr style="display:none;">' : '<tr style="background:#FCFCFC;">'; ?>
            ...
            <td><select name="mediaplayer_header_shape">
              <?php foreach ($shapes as $shape) { ?>
                <?php if ($shape['shape'] == $mediaplayer_header_shape) { ?>
        ...
        <tbody>
          <?php echo $stylesheet_mode ? '<tr style="display:none;">' : '<tr>'; ?>
            ...
            <td><select name="mediaplayer_content_color">
              <?php foreach ($skins as $skin) { ?>
                <?php if ($skin['skin'] == $mediaplayer_content_color) { ?>
                  <option value="<?php echo $skin['skin']; ?>" style="background-color:<?php echo $skin['color']; ?>; padding:2px 4px;" selected="selected"><?php echo $skin['title']; ?></option>
                <?php } else { ?>
                  <option value="<?php echo $skin['skin']; ?>" style="background-color:<?php echo $skin['color']; ?>; padding:2px 4px;"><?php echo $skin['title']; ?></option>
                <?php } ?>
          ...
          <?php echo $stylesheet_mode ? '<tr style="display:none;">' : '<tr>'; ?>
            ...
            <td><select name="mediaplayer_content_shape">
              <?php foreach ($shapes as $shape) { ?>
                <?php if ($shape['shape'] == $mediaplayer_content_shape) { ?>
                  <option value="<?php echo $shape['shape']; ?>" selected="selected"><?php echo $shape['title']; ?></option>
                <?php } else { ?>
                  <option value="<?php echo $shape['shape']; ?>"><?php echo $shape['title']; ?></option>
                <?php } ?>
        ...
        <table id="module" class="list">
          ...
          <tfoot>
            <tr>
              <td colspan="6" style="text-align:center; color:#444; font-size:10px;">Powered by <?php echo $mediaplayer_plugin; ?> <?php echo $mediaplayer_version; ?></td>
...
$('input[name=\'mediaplayer_theme\']').bind('change', function() {
	$('.module-header').hide();
	$('#header-' + this.value).show();
});

$('input[name=\'mediaplayer_theme\']:checked').trigger('change');
//--></script>
