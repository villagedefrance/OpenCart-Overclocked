        ...
        <table class="form">
          <tr>
            ...
            <td><?php if ($news_theme) { ?>
              <?php echo $text_yes; ?><input type="radio" name="news_theme" value="1" checked="checked" />
              <?php echo $text_no; ?><input type="radio" name="news_theme" value="0" />
            <?php } else { ?>
              <?php echo $text_yes; ?><input type="radio" name="news_theme" value="1" />
              <?php echo $text_no; ?><input type="radio" name="news_theme" value="0" checked="checked" />
            <?php } ?></td>
          </tr>
          <tr>
