          ...
          <?php echo $stylesheet_mode ? '<tr style="display:none;">' : '<tr class="highlighted">'; ?>
            ...
            <td><select name="slideshow_header_color">
              <?php foreach ($skins as $skin) { ?>
                <?php if ($skin['skin'] == $slideshow_header_color) { ?>
          ...
          <?php echo $stylesheet_mode ? '<tr style="display:none;">' : '<tr class="highlighted">'; ?>
            ...
            <td><select name="slideshow_header_shape">
              <?php foreach ($shapes as $shape) { ?>
                <?php if ($shape['shape'] == $slideshow_header_shape) { ?>
...
$('input[name=\'slideshow_theme\']').bind('change', function() {
	$('.module-header').hide();
	$('#header-' + this.value).show();
});

$('input[name=\'slideshow_theme\']:checked').trigger('change');
//--></script>
