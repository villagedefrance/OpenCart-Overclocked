...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="store">
        <table class="form">
        <tbody>
          <tr>
            <td><?php echo $entry_theme; ?></td>
            <td><?php if ($store_theme) { ?>
              <input type="radio" name="store_theme" value="1" id="theme-on" class="radio" checked />
              <label for="theme-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="store_theme" value="0" id="theme-off" class="radio" />
              <label for="theme-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } else { ?>
              <input type="radio" name="store_theme" value="1" id="theme-on" class="radio" />
              <label for="theme-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="store_theme" value="0" id="theme-off" class="radio" checked />
              <label for="theme-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } ?></td>
          </tr>
        </tbody>
        <tbody id="header-1" class="module-header">
          <tr class="highlighted">
            ...
            <td><?php foreach ($languages as $language) { ?>
              <input type="text" name="store_title<?php echo $language['language_id']; ?>" id="store_title<?php echo $language['language_id']; ?>" size="30" value="<?php echo ${'store_title' . $language['language_id']}; ?>" />
          ...
          <?php echo $stylesheet_mode ? '<tr style="display:none;">' : '<tr class="highlighted">'; ?>
            ...
            <td><select name="store_header_color">
              <?php foreach ($skins as $skin) { ?>
                <?php if ($skin['skin'] == $store_header_color) { ?>
          ...
          <?php echo $stylesheet_mode ? '<tr style="display:none;">' : '<tr class="highlighted">'; ?>
            ...
            <td><select name="store_header_shape">
              <?php foreach ($shapes as $shape) { ?>
                <?php if ($shape['shape'] == $store_header_shape) { ?>
        ...
        <tbody>
          <?php echo $stylesheet_mode ? '<tr style="display:none;">' : '<tr>'; ?>
            ...
            <td><select name="store_content_color">
              <?php foreach ($skins as $skin) { ?>
                <?php if ($skin['skin'] == $store_content_color) { ?>
                  <option value="<?php echo $skin['skin']; ?>" style="background-color:<?php echo $skin['color']; ?>; padding:2px 4px;" selected="selected"><?php echo $skin['title']; ?></option>
                <?php } else { ?>
                  <option value="<?php echo $skin['skin']; ?>" style="background-color:<?php echo $skin['color']; ?>; padding:2px 4px;"><?php echo $skin['title']; ?></option>
                <?php } ?>
          ...
          <?php echo $stylesheet_mode ? '<tr style="display:none;">' : '<tr>'; ?>
            ...
            <td><select name="store_content_shape">
              <?php foreach ($shapes as $shape) { ?>
                <?php if ($shape['shape'] == $store_content_shape) { ?>
                  <option value="<?php echo $shape['shape']; ?>" selected="selected"><?php echo $shape['title']; ?></option>
                <?php } else { ?>
                  <option value="<?php echo $shape['shape']; ?>"><?php echo $shape['title']; ?></option>
                <?php } ?>
        ...
        <table id="module" class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php echo $entry_permission; ?></td>
              <td class="left"><?php echo $entry_access; ?></td>
        ...
        <?php foreach ($modules as $module) { ?>
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><?php echo $text_permission; ?> &nbsp;
                <input type="checkbox" name="store_module[<?php echo $module_row; ?>][permission]" value="1" <?php if (isset($module['permission'])) { echo 'checked="checked"'; } ?> />
              </td>
              <td class="left"><?php echo $text_access; ?> &nbsp;
                <input type="checkbox" name="store_module[<?php echo $module_row; ?>][access]" value="1" <?php if (isset($module['access'])) { echo 'checked="checked"'; } ?> />
              </td>
              ...
              <td class="center">
                <input type="text" name="store_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" />
              </td>
              <td class="center">
...
$('input[name=\'store_theme\']').bind('change', function() {
	$('.module-header').hide();
	$('#header-' + this.value).show();
});

$('input[name=\'store_theme\']:checked').trigger('change');
//--></script>
...
function addModule() {
	...
	html += '    </select></td>';
	html += '    <td class="left">';
	html += '      <?php echo $text_permission; ?> &nbsp;<input type="checkbox" name="store_module[' + module_row + '][permission]" value="1" />';
	html += '    </td>';
	html += '    <td class="left">';
	html += '      <?php echo $text_access; ?> &nbsp;<input type="checkbox" name="store_module[' + module_row + '][access]" value="1" />';
	html += '    </td>';
	...
	html += '    </select></td>';
	html += '    <td class="center"><input type="text" name="store_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
