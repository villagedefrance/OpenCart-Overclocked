...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="viewed">
        <table class="form">
        <tbody>
          <tr>
            <td><?php echo $entry_theme; ?></td>
            <td><?php if ($viewed_theme) { ?>
              <input type="radio" name="viewed_theme" value="1" id="theme-on" class="radio" checked />
              <label for="theme-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="viewed_theme" value="0" id="theme-off" class="radio" />
              <label for="theme-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } else { ?>
              <input type="radio" name="viewed_theme" value="1" id="theme-on" class="radio" />
              <label for="theme-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="viewed_theme" value="0" id="theme-off" class="radio" checked />
              <label for="theme-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } ?></td>
          </tr>
        </tbody>
          ...
          <tr style="background:#FCFCFC;">
            ...
            <td><select name="viewed_header_color">
              <?php foreach ($skins as $skin) { ?>
                <?php if ($skin['skin'] == $viewed_header_color) { ?>
          ...
          <tr style="background:#FCFCFC;">
            ...
            <td><select name="viewed_header_shape">
              <?php foreach ($shapes as $shape) { ?>
                <?php if ($shape['shape'] == $viewed_header_shape) { ?>
        ...
        <tbody>
          <tr>
            ...
            <td><select name="viewed_content_color">
              <?php foreach ($skins as $skin) { ?>
                <?php if ($skin['skin'] == $viewed_content_color) { ?>
                  <option value="<?php echo $skin['skin']; ?>" style="background-color:<?php echo $skin['color']; ?>; padding:2px 4px;" selected="selected"><?php echo $skin['title']; ?></option>
                <?php } else { ?>
                  <option value="<?php echo $skin['skin']; ?>" style="background-color:<?php echo $skin['color']; ?>; padding:2px 4px;"><?php echo $skin['title']; ?></option>
                <?php } ?>
          ...
          <tr>
            ...
            <td><select name="viewed_content_shape">
              <?php foreach ($shapes as $shape) { ?>
                <?php if ($shape['shape'] == $viewed_content_shape) { ?>
                  <option value="<?php echo $shape['shape']; ?>" selected="selected"><?php echo $shape['title']; ?></option>
                <?php } else { ?>
                  <option value="<?php echo $shape['shape']; ?>"><?php echo $shape['title']; ?></option>
                <?php } ?>
          ...
          <tr style="background:#FCFCFC;">
            ...
            <td><?php if ($viewed_viewproduct) { ?>
              ...
              <input type="radio" name="viewed_viewproduct" value="0" id="viewproduct-off" class="radio" />
              <label for="viewproduct-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } else { ?>
              <input type="radio" name="viewed_viewproduct" value="1" id="viewproduct-on" class="radio" />
              <label for="viewproduct-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="viewed_viewproduct" value="0" id="viewproduct-off" class="radio" checked />
              <label for="viewproduct-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } ?></td>
          </tr>
          <tr style="background:#FCFCFC;">
            ...
            <td><?php if ($viewed_addproduct) { ?>
              ...
              <input type="radio" name="viewed_addproduct" value="0" id="addproduct-off" class="radio" />
              <label for="addproduct-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } else { ?>
              <input type="radio" name="viewed_addproduct" value="1" id="addproduct-on" class="radio" />
              <label for="addproduct-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="viewed_addproduct" value="0" id="addproduct-off" class="radio" checked />
              <label for="addproduct-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } ?></td>
          </tr>
        </tbody>
        ...
        <?php foreach ($modules as $module) { ?>
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left">
                <input type="text" name="viewed_module[<?php echo $module_row; ?>][image_width]" value="<?php echo $module['image_width']; ?>" size="3" /> x 
                <input type="text" name="viewed_module[<?php echo $module_row; ?>][image_height]" value="<?php echo $module['image_height']; ?>" size="3" /> px
              ...
              <td class="center">
                <input type="text" name="viewed_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" />
              </td>
              <td class="center">
...
$('input[name=\'viewed_theme\']').bind('change', function() {
	$('.module-header').hide();
	$('#header-' + this.value).show();
});

$('input[name=\'viewed_theme\']:checked').trigger('change');
//--></script>
...
function addModule() {
	...
	html += '    <td class="left">';
	html += '      <input type="text" name="viewed_module[' + module_row + '][image_width]" value="120" size="3" /> x ';
	html += '      <input type="text" name="viewed_module[' + module_row + '][image_height]" value="120" size="3" /> px';
	html += '    </td>';
	...
	html += '    </select></td>';
	html += '    <td class="center"><input type="text" name="viewed_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
