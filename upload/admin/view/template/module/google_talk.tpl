...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="talk">
        <table class="form">
          <tr>
            <td><?php echo $entry_theme; ?></td>
            <td><?php if ($google_talk_theme) { ?>
			  <input type="radio" name="google_talk_theme" value="1" id="theme-on" class="radio" checked />
              <label for="theme-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="google_talk_theme" value="0" id="theme-off" class="radio" />
			  <label for="theme-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } else { ?>
              <input type="radio" name="google_talk_theme" value="1" id="theme-on" class="radio" />
              <label for="theme-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="google_talk_theme" value="0" id="theme-off" class="radio" checked />
			  <label for="theme-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } ?></td>
          </tr>
          <tr>
            ...
            <td><?php foreach ($languages as $language) { ?>
              <input type="text" name="google_talk_title<?php echo $language['language_id']; ?>" id="google_talk_title<?php echo $language['language_id']; ?>" size="30" value="<?php echo ${'google_talk_title' . $language['language_id']}; ?>" />
          ...
          <tr>
            ...
            <td>
              <textarea name="google_talk_code" cols="80" rows="5"><?php echo $google_talk_code; ?></textarea>
              <?php if ($error_code) { ?>
        ...
        <?php foreach ($modules as $module) { ?>
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="center">
                <input type="text" name="google_talk_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" />
              </td>
              <td class="center">
...
function addModule() {
	...
	html += '    </select></td>';
	html += '    <td class="center"><input type="text" name="google_talk_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
