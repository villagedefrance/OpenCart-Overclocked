...
<table class="list">
  ...
  <?php if ($rewards) { ?>
    ...
    <tr>
      ...
      <td class="center"><a id="button-delete-reward-<?php echo $reward['customer_reward_id']; ?>" onclick="deleteRewardPoints(<?php echo $reward['customer_reward_id']; ?>);"><img src="view/image/delete.png" alt="<?php echo $button_delete; ?>" /></a></td>
    </tr>
  <?php } ?>
    <tr>
      <td>&nbsp;</td>
