...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
        <a href="<?php echo $dashboard; ?>" class="button-cancel"><i class="fa fa-arrow-left"></i> &nbsp; <?php echo $button_dashboard; ?></a>
        ...
        <?php if ($offer_product_categories) { ?>
          ...
          <tr>
            <td style="text-align:center;"><?php if ($offer_product_category['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_product_category['offer_product_category_id']; ?>" id="<?php echo $offer_product_category['offer_product_category_id']; ?>" class="checkbox" checked />
              <label for="<?php echo $offer_product_category['offer_product_category_id']; ?>"><span></span></label>
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_product_category['offer_product_category_id']; ?>" id="<?php echo $offer_product_category['offer_product_category_id']; ?>" class="checkbox" />
              <label for="<?php echo $offer_product_category['offer_product_category_id']; ?>"><span></span></label>
            <?php } ?></td>
