...
<div id="content">
  ...
  <div class="box">
    ...
    <?php if ($fraud_maxmind) { ?>
      <a href="#tab-maxmind"><?php echo $tab_maxmind; ?></a>
    <?php } ?>
    <?php if ($fraud_fraudlabspro) { ?>
      <a href="#tab-fraudlabspro"><?php echo $tab_fraudlabspro; ?></a>
    <?php } ?>
    </div>
  ...
  <?php if ($fraud_maxmind) { ?>
    <div id="tab-maxmind" class="vtabs-content">
      <table class="form">
        ...
        <tr>
          <td></td>
          <td><a href="<?php echo $fraud_maxmind; ?>" class="button"><?php echo $button_maxmind; ?></a></td>
        </tr>
      </table>
    </div>
  <?php } ?>
  <?php if ($fraud_fraudlabspro) { ?>
    <div id="tab-fraudlabspro" class="vtabs-content">
      <table class="form">
        <tr>
          <td><?php echo $text_flp_ip_address; ?></td>
          <td><?php echo $flp_ip_address; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_ip_net_speed; ?></td>
          <td><?php echo $flp_ip_net_speed; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_ip_isp_name; ?></td>
          <td><?php echo $flp_ip_isp_name; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_ip_usage_type; ?></td>
          <td><?php echo $flp_ip_usage_type; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_ip_domain; ?></td>
          <td><?php echo $flp_ip_domain; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_ip_time_zone; ?></td>
          <td><?php echo $flp_ip_time_zone; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_ip_location; ?></td>
          <td><?php echo $flp_ip_location; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_ip_distance; ?></td>
          <td><?php echo $flp_ip_distance; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_ip_latitude; ?></td>
          <td><?php echo $flp_ip_latitude; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_ip_longitude; ?></td>
          <td><?php echo $flp_ip_longitude; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_risk_country; ?></td>
          <td><?php echo $flp_risk_country; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_free_email; ?></td>
          <td><?php echo $flp_free_email; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_ship_forward; ?></td>
          <td><?php echo $flp_ship_forward; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_using_proxy; ?></td>
          <td><?php echo $flp_using_proxy; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_bin_found; ?></td>
          <td><?php echo $flp_bin_found; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_email_blacklist; ?></td>
          <td><?php echo $flp_email_blacklist; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_credit_card_blacklist; ?></td>
          <td><?php echo $flp_credit_card_blacklist; ?></td>
        </tr>
        <tr>
          <td><?php echo $text_flp_message; ?></td>
          <td colspan="5"><?php echo $flp_message; ?></td>
        </tr>
        <tr style="background:#EEE;">
          <td><?php echo $text_flp_score; ?></td>
          <td><span style="font-size:2em; font-weight:bold;"><?php echo $flp_score; ?></span></td>
        </tr>
        <tr style="background:#EEE;">
          <td><?php echo $text_flp_status; ?></td>
		  <td id="flp_status">
