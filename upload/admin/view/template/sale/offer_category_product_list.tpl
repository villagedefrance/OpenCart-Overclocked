        ...
        <?php if ($offer_category_products) { ?>
          ...
          <tr>
            <td style="text-align:center;"><?php if ($offer_category_product['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_category_product['offer_category_product_id']; ?>" checked="checked" />
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_category_product['offer_category_product_id']; ?>" />
            <?php } ?></td>
            ...
            <td class="center"><?php echo $offer_category_product['status']; ?></td>
