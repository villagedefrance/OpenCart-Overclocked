        ...
        <?php if ($offer_product_products) { ?>
          ...
          <tr>
            <td style="text-align:center;"><?php if ($offer_product_product['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_product_product['offer_product_product_id']; ?>" id="<?php echo $offer_product_product['offer_product_product_id']; ?>" class="checkbox" checked />
              <label for="<?php echo $offer_product_product['offer_product_product_id']; ?>"><span></span></label>
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_product_product['offer_product_product_id']; ?>" id="<?php echo $offer_product_product['offer_product_product_id']; ?>" class="checkbox" />
              <label for="<?php echo $offer_product_product['offer_product_product_id']; ?>"><span></span></label>
            <?php } ?></td>
