    ...
    <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="list">
        ...
        <?php if ($offer_product_products) { ?>
          <?php foreach ($offer_product_products as $offer_product_product) { ?>
          <tr>
            <td style="text-align:center;"><?php if ($offer_product_product['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_product_product['offer_product_product_id']; ?>" checked="checked" />
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_product_product['offer_product_product_id']; ?>" />
            <?php } ?></td>
