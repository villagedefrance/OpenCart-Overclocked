        ...
        <?php if ($offer_category_categories) { ?>
          ...
          <tr>
            <td style="text-align:center;"><?php if ($offer_category_category['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_category_category['offer_category_category_id']; ?>" id="<?php echo $offer_category_category['offer_category_category_id']; ?>" class="checkbox" checked />
              <label for="<?php echo $offer_category_category['offer_category_category_id']; ?>"><span></span></label>
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_category_category['offer_category_category_id']; ?>" id="<?php echo $offer_category_category['offer_category_category_id']; ?>" class="checkbox" />
              <label for="<?php echo $offer_category_category['offer_category_category_id']; ?>"><span></span></label>
            <?php } ?></td>
