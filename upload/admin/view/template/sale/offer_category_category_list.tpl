    ...
    <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="list">
        ...
        <?php if ($offer_category_categories) { ?>
          <?php foreach ($offer_category_categories as $offer_category_category) { ?>
          <tr>
            <td style="text-align:center;"><?php if ($offer_category_category['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_category_category['offer_category_category_id']; ?>" checked="checked" />
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $offer_category_category['offer_category_category_id']; ?>" />
            <?php } ?></td>
            <td class="left"><?php echo $offer_category_category['name']; ?></td>
            <td class="center"><?php echo $offer_category_category['discount']; ?></td>
			<td class="center"><?php echo $offer_category_category['type']; ?></td>
            ...
            <td class="center"><?php echo $offer_category_category['status']; ?></td>
            <td class="right"><?php foreach ($offer_category_category['action'] as $action) { ?>
