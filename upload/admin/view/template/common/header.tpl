    ...
    <ul class="menu">
      ...
      <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
        <ul>
          ...
          <li><a class="arrow"><?php echo ($icons) ? '<i class="fa fa-plus"></i>&nbsp;&nbsp;' : ''; ?><?php echo $text_attribute; ?></a>
            <ul>
              <li><a href="<?php echo $attribute; ?>"><?php echo ($icons) ? '<i class="fa fa-plus"></i>&nbsp;&nbsp;' : ''; ?><?php echo $text_attribute; ?></a></li>
              <li><a href="<?php echo $attribute_group; ?>"><?php echo ($icons) ? '<i class="fa fa-clipboard"></i>&nbsp;&nbsp;' : ''; ?><?php echo $text_attribute_group; ?></a></li>
            </ul>
          </li>
      ...
      <li id="sale"><a class="top"><?php echo $text_sale; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $affiliate; ?>"><?php echo ($icons) ? '<i class="fa fa-plug"></i>&nbsp;&nbsp;' : ''; ?><?php echo $text_affiliate; ?></a></li>
          <?php } ?>
        ...
        <ul>
          ...
          <li><a class="arrow"><?php echo ($icons) ? '<i class="fa fa-exclamation-circle"></i>&nbsp;&nbsp;' : ''; ?><?php echo $text_logs; ?></a>
            <ul>
              ...
              <li><a href="<?php echo $email_log; ?>"><?php echo ($icons) ? '<i class="fa fa-inbox"></i>&nbsp;&nbsp;' : ''; ?><?php echo $text_email_log; ?></a></li>
        ...
        <ul>
          ...
          <li><a class="arrow"><?php echo ($icons) ? '<i class="fa fa-user"></i>&nbsp;&nbsp;' : ''; ?><?php echo $text_customer; ?></a>
            <ul>
              ...
              <li><a href="<?php echo $report_customer_online; ?>"><?php echo ($icons) ? '<i class="fa fa-sign-in"></i>&nbsp;&nbsp;' : ''; ?><?php echo $text_report_customer_online; ?></a></li>
            </ul>
          </li>
          <li><a class="arrow"><?php echo ($icons) ? '<i class="fa fa-plug"></i>&nbsp;&nbsp;' : ''; ?><?php echo $text_affiliate; ?></a>
            <ul>
