      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><input name="amazon_checkout_merchant_id" value="<?php echo $amazon_checkout_merchant_id; ?>" id="amazon_checkout_merchant_id" size="40" /></td>
          </tr>
          <tr>
            <td><span class="required">*</span> <label for="amazon_checkout_access_key"><?php echo $text_access_key; ?></label></td>
            <td><input name="amazon_checkout_access_key" value="<?php echo $amazon_checkout_access_key; ?>" id="amazon_checkout_access_key" size="40" /></td>
          </tr>
          <tr>
            <td><span class="required">*</span> <label for="amazon_checkout_access_secret"><?php echo $text_access_secret; ?></label></td>
            <td><input name="amazon_checkout_access_secret" value="<?php echo $amazon_checkout_access_secret; ?>" id="amazon_checkout_access_secret" size="40" /></td>
          </tr>
          <tr>
            <td><label for="amazon_checkout_status"><?php echo $text_status; ?></label></td>
            <td><select name="amazon_checkout_status" id="amazon_checkout_status">
          ...
          <tr>
            ...
            <td><select name="amazon_checkout_mode" id="amazon_checkout_mode">
          ...
          <tr>
            ...
            <td><select name="amazon_checkout_marketplace" id="amazon_checkout_marketplace">
          ...
          <tr>
            ...
            <td><select name="amazon_checkout_geo_zone" id="amazon_checkout_geo_zone">
          ...
          <tr>
            ...
            <td><select id="amazon_checkout_order_default_status" name="amazon_checkout_order_default_status">
          ...
          <tr>
            ...
            <td><select id="amazon_checkout_order_ready_status" name="amazon_checkout_order_ready_status">
              <?php foreach ($order_statuses as $order_status) { ?>
          ...
          <tr>
            ...
            <td><select id="amazon_checkout_order_shipped_status" name="amazon_checkout_order_shipped_status">
              <?php foreach ($order_statuses as $order_status) { ?>
          ...
          <tr>
            ...
            <td><select id="amazon_checkout_order_canceled_status" name="amazon_checkout_order_canceled_status">
              <?php foreach ($order_statuses as $order_status) { ?>
          ...
          <tr>
            <td><label for="amazon_checkout_cron_job_token"><?php echo $text_cron_job_token; ?></label><br /><span class="help"><?php echo $help_cron_job_token; ?></span></td>
            <td><input name="amazon_checkout_cron_job_token" value="<?php echo $amazon_checkout_cron_job_token; ?>" id="amazon_checkout_cron_job_token" size="50" /></td>
          </tr>
          <tr>
            <td><?php echo $text_cron_job_url; ?><br /><span class="help"><?php echo $help_cron_job_url; ?></span></td>
            <td><span id="cron-job-url"><?php echo $cron_job_url; ?></span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="allowed-ip" />&nbsp;&nbsp;<a class="button-form" id="add-ip"><?php echo $text_add; ?></a></td>
          </tr>
          <tr>
            <td></td>
            <td><div id="allowed-ips" class="scrollbox">
              <?php $class = 'odd'; ?>
              <?php $count = 0; ?>
          ...
          <tr>
            ...
            <td><select name="amazon_checkout_button_colour" id="amazon_checkout_button_colour">
          ...
          <tr>
            ...
            <td><select name="amazon_checkout_button_background" id="amazon_checkout_button_background">
          ...
          <tr>
            ...
            <td><select name="amazon_checkout_button_size" id="amazon_checkout_button_size">
