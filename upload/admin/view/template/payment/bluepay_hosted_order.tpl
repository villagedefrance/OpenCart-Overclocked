...
<div class="success" id="bluepay_hosted_transaction_msg" style="display:none;"></div>
<table class="form">
  <tr>
  ...
  <tr>
    ...
    <td>
      <table class="table table-striped table-bordered" id="bluepay_hosted_transactions">
        <thead>
          <tr>
		...
		$.ajax({
			...
			success: function(data) {
				if (data.error == false) {
					...
					if (data.msg != '') {
						$('#bluepay_hosted_transaction_msg').empty().html(data.msg).fadeIn();
					}
				}
