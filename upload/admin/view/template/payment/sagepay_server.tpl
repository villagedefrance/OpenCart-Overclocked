        ...
        <table class="form">
          <tr>
            ...
            <td><?php if ($error_vendor) { ?>
              <input type="text" name="sagepay_server_vendor" value="<?php echo $sagepay_server_vendor; ?>" id="input-vendor" size="40" class="input-error" />
              <span class="error"><?php echo $error_vendor; ?></span>
            <?php } else { ?>
              <input type="text" name="sagepay_server_vendor" value="<?php echo $sagepay_server_vendor; ?>" id="input-vendor" size="40" />
            <?php } ?></td>
          </tr>
          <tr>
            <td><label for="input-test"><?php echo $entry_test; ?></label></td>
            <td><select name="sagepay_server_test" id="input-test">
          ...
          <tr>
            ...
            <td><select name="sagepay_server_transaction" id="input-transaction">
          ...
          <tr>
            ...
            <td><input type="text" name="sagepay_server_total" value="<?php echo !empty($sagepay_server_total) ? $sagepay_server_total : '0.00'; ?>" id="input-total" /></td>
          </tr>
          <tr>
            <td><label for="input-total-max"><?php echo $entry_total_max; ?><br /><span class="help"><?php echo $help_total_max; ?></span></label></td>
            <td><input type="text" name="sagepay_server_total_max" value="<?php echo !empty($sagepay_server_total_max) ? $sagepay_server_total_max : '0.00'; ?>" id="input-total-max" /></td>
          </tr>
          <tr>
            <td><label for="input-card"><?php echo $entry_card; ?></label></td>
            <td><select name="sagepay_server_card" id="input-card">
          ...
          <tr>
            ...
            <td><select name="sagepay_server_order_status_id" id="input-order-status">
          ...
          <tr>
            ...
            <td><select name="sagepay_server_geo_zone_id" id="input-geo-zone">
          ...
          <tr>
            ...
            <td><select name="sagepay_server_debug" id="input-debug">
          ...
          <tr>
            ...
            <td><select name="sagepay_server_status" id="input-status">
          ...
          <tr>
            ...
            <td><input type="text" name="sagepay_server_sort_order" value="<?php echo $sagepay_server_sort_order; ?>" id="input-sort-order" size="1" /></td>
          </tr>
          <tr>
            <td><label for="sagepay-server-cron-job-token"><?php echo $entry_cron_job_token; ?><br /><span class="help"><?php echo $help_cron_job_token; ?></span></label></td>
            <td><input type="text" name="sagepay_server_cron_job_token" value="<?php echo $sagepay_server_cron_job_token; ?>" id="sagepay-server-cron-job-token" size="80" /></td>
          </tr>
          <tr>
            <td><label for="cron-job-url"><?php echo $entry_cron_job_url; ?><br /><span class="help"><?php echo $help_cron_job_url; ?></span></label></td>
            <td><input type="text" name="sagepay_server_cron_job_url" value="<?php echo $sagepay_server_cron_job_url ?>" id="input-cron-job-url" size="80" /></td>
          </tr>
          <?php if ($sagepay_server_last_cron_job_run) { ?>
          <tr>
            <td><?php echo $entry_last_cron_job_run; ?></td>
            <td><?php echo $sagepay_server_last_cron_job_run; ?></td>
          </tr>
          <?php } ?>
        </table>
      </form>
