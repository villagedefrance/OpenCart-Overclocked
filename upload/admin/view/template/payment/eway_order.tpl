...
<div class="success" id="eway-transaction-msg" style="display:none;"></div>
<table class="form">
  <tr>
  ...
  <tr>
    ...
    <td>
      <?php if (($eway_order['void_status'] == 0) && ($eway_order['capture_status'] == 0) ) { ?>
        ...
        <a class="button" id="btn-capture"><?php echo $btn_capture; ?></a>&nbsp;<img src="view/image/loading.gif" alt="" id="img-loading-capture" style="display:none;" />
      <?php } ?>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2">
      <table class="list" id="eway-transactions">
        <thead>
          <tr>
            <td class="left"><strong><?php echo $text_column_transactionid; ?></strong></td>
            <td class="left"><strong><?php echo $text_column_created; ?></strong></td>
    ...
    $.ajax({
      ...
      success: function(data) {
        if (data.error == false) {
          html = '';
          html += '<tr>';
          html += '<td class="left">' + data.data.transactionid + '</td>';
