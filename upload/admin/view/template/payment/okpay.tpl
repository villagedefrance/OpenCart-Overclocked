      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <?php } else { ?>
              <input type="text" name="okpay_receiver" id="input-receiver" value="<?php echo $okpay_receiver; ?>" size="30" />
            <?php } ?></td>
          </tr>
          <tr>
            <td><label for="input-total"><?php echo $entry_total; ?><br /><span class="help"><?php echo $help_total; ?></span></label></td>
            <td><input type="text" name="okpay_total" id="input-total" value="<?php echo !empty($okpay_total) ? $okpay_total : '0.00'; ?>" /></td>
          </tr>
          <tr>
            <td><label for="input-total-max"><?php echo $entry_total_max; ?><br /><span class="help"><?php echo $help_total_max; ?></span></label></td>
            <td><input type="text" name="okpay_total_max" id="input-total-max" value="<?php echo !empty($okpay_total_max) ? $okpay_total_max : '0.00'; ?>" /></td>
          </tr>
          <tr>
            <td><label for="input-order-status"><?php echo $entry_order_status; ?></label></td>
            <td><select name="okpay_order_status_id" id="input-order-status">
          ...
          <tr>
            ...
            <td><select name="okpay_geo_zone_id" id="input-geo-zone">
          ...
          <tr>
            ...
            <td><select name="okpay_status" id="input-status">
              <?php if ($okpay_status) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="okpay_sort_order" value="<?php echo $okpay_sort_order; ?>" id="input-sort-order" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
