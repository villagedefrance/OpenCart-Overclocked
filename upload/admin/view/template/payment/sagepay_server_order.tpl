...
<table class="table table-striped table-bordered">
  ...
  <tr>
    ...
    <td id="release_status">
      ...
      <a class="button" id="button-release"><?php echo $button_release; ?></a> <span class="btn btn-primary" id="img-loading-release" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
      <?php } ?>
      <?php } ?>
    </td>
  </tr>
  <tr>
    ...
    <td id="void_status">
      ...
      <?php } elseif ($sagepay_server_order['void_status'] == 0 && $sagepay_server_order['release_status'] != 1 && $sagepay_server_order['rebate_status'] != 1) { ?>
        <span class="void_text"><?php echo $text_no; ?></span>&nbsp;&nbsp; <a class="button btn btn-primary" id="button-void"><?php echo $button_void; ?></a> <span class="btn btn-primary" id="img-loading-void" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
      <?php } else { ?>
    ...
    <td id="rebate_status">
     <?php if ($sagepay_server_order['rebate_status'] == 1) { ?>
      ...
      <?php if ($sagepay_server_order['total_released'] > 0 && $sagepay_server_order['void_status'] == 0) { ?>
        ...
        <a class="button" id="button-rebate"><?php echo $button_rebate; ?></a> <span class="btn btn-primary" id="img-loading-rebate" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
      <?php } ?>
      <?php } ?>
    </td>
  </tr>
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data.error == false) {
            ...
            if (data.msg != '') {
              $('#sagepay-server-transaction-msg').empty().html('<i class="fa fa-check-circle"></i> ' + data.msg).fadeIn();
            }
