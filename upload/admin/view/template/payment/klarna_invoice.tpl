        ...
        <div id="tab-<?php echo $country['code']; ?>" class="vtabs-content">
          <table class="form">
            <tr>
              ...
              <td><input type="text" name="klarna_invoice[<?php echo $country['code']; ?>][merchant]" value="<?php echo isset($klarna_invoice[$country['code']]) ? $klarna_invoice[$country['code']]['merchant'] : ''; ?>" size="40" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_secret; ?></td>
              <td><input type="text" name="klarna_invoice[<?php echo $country['code']; ?>][secret]" value="<?php echo isset($klarna_invoice[$country['code']]) ? $klarna_invoice[$country['code']]['secret'] : ''; ?>" size="40" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="text" name="klarna_invoice[<?php echo $country['code']; ?>][sort_order]" value="<?php echo isset($klarna_invoice[$country['code']]) ? $klarna_invoice[$country['code']]['sort_order'] : ''; ?>" size="3" /></td>
            </tr>
          </table>
        </div>
        <?php } ?>
