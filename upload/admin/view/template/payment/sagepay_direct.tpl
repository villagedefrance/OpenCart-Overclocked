        ...
        <table class="form">
          <tr>
            ...
            <td><?php if ($error_vendor) { ?>
              <input type="text" name="sagepay_direct_vendor" value="<?php echo $sagepay_direct_vendor; ?>" size="40" class="input-error" />
              <span class="error"><?php echo $error_vendor; ?></span>
            <?php } else { ?>
              <input type="text" name="sagepay_direct_vendor" value="<?php echo $sagepay_direct_vendor; ?>" size="40" />
            <?php } ?></td>
          </tr>
          <tr>
