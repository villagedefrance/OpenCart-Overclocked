      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="free_checkout_total" value="<?php echo !empty($free_checkout_total) ? $free_checkout_total : '0.00'; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_total_max; ?></td>
            <td><input type="text" name="free_checkout_total_max" value="<?php echo $free_checkout_total_max; ?>" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><select name="free_checkout_geo_zone_id">
