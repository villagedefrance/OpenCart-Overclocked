      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="pp_pro_username" value="<?php echo $pp_pro_username; ?>" size="40" />
          ...
          <tr>
            ...
            <td><input type="text" name="pp_pro_password" value="<?php echo $pp_pro_password; ?>" size="40" />
          ...
          <tr>
            ...
            <td><input type="text" name="pp_pro_signature" value="<?php echo $pp_pro_signature; ?>" size="40" />
