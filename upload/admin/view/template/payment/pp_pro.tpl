        ...
        <table class="form">
          <tr>
            ...
            <td><?php if ($error_username) { ?>
              <input type="text" name="pp_pro_username" value="<?php echo $pp_pro_username; ?>" size="40" class="input-error" />
              <span class="error"><?php echo $error_username; ?></span>
            <?php } else { ?>
              <input type="text" name="pp_pro_username" value="<?php echo $pp_pro_username; ?>" size="40" />
            <?php } ?></td>
          </tr>
          <tr>
            <td><span class="required">*</span> <?php echo $entry_password; ?></td>
            <td><?php if ($error_password) { ?>
              <input type="text" name="pp_pro_password" value="<?php echo $pp_pro_password; ?>" size="40" class="input-error" />
              <span class="error"><?php echo $error_password; ?></span>
            <?php } else { ?>
              <input type="text" name="pp_pro_password" value="<?php echo $pp_pro_password; ?>" size="40" />
            <?php } ?></td>
          </tr>
          <tr>
            <td><span class="required">*</span> <?php echo $entry_signature; ?></td>
            <td><?php if ($error_signature) { ?>
              <input type="text" name="pp_pro_signature" value="<?php echo $pp_pro_signature; ?>" size="40" class="input-error" />
              <span class="error"><?php echo $error_signature; ?></span>
            <?php } else { ?>
              <input type="text" name="pp_pro_signature" value="<?php echo $pp_pro_signature; ?>" size="40" />
            <?php } ?></td>
          </tr>
          <tr>
