...
<div id="content">
  ...
  <table>
    <tr>
      <th width="35%" style="text-align:left;"><b>PHP Settings</b></th>
      <th width="25%" style="text-align:left;"><b>Current Settings</b></th>
      <th width="25%" style="text-align:left;"><b>Required Settings</b></th>
    ...
    <tr>
      ...
      <td>5.2+</td>
      <td style="text-align:center;"><?php echo (phpversion() >= '5.2') ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
    <tr>
      <td>Register Globals:</td>
      <td><?php echo (ini_get('register_globals')) ? 'On' : 'Off'; ?></td>
      <td>Off</td>
      <td style="text-align:center;"><?php echo (!ini_get('register_globals')) ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
    <tr>
      <td>Magic Quotes GPC:</td>
      <td><?php echo (ini_get('magic_quotes_gpc')) ? 'On' : 'Off'; ?></td>
      <td>Off</td>
      <td style="text-align:center;"><?php echo (!ini_get('magic_quotes_gpc')) ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
    <tr>
      <td>File Uploads:</td>
      <td><?php echo (ini_get('file_uploads')) ? 'On' : 'Off'; ?></td>
      <td>On</td>
      <td style="text-align:center;"><?php echo (ini_get('file_uploads')) ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
    <tr>
      <td>Session Auto Start:</td>
      <td><?php echo (ini_get('session_auto_start')) ? 'On' : 'Off'; ?></td>
      <td>Off</td>
      <td style="text-align:center;"><?php echo (!ini_get('session_auto_start')) ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
  </table>
  </fieldset>
  ...
  <table>
    <tr>
      <th width="35%" style="text-align:left;"><b>Extension</b></th>
      <th width="25%" style="text-align:left;"><b>Current Settings</b></th>
      <th width="25%" style="text-align:left;"><b>Required Settings</b></th>
      <th width="15%" style="text-align:center;"><b>Status</b></th>
    </tr>
    <tr>
      ...
      <td>On</td>
      <td style="text-align:center;"><?php echo extension_loaded('mysql') ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
    <tr>
      <td>GD:</td>
      <td><?php echo extension_loaded('gd') ? 'On' : 'Off'; ?></td>
      <td>On</td>
      <td style="text-align:center;"><?php echo extension_loaded('gd') ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
    <tr>
      <td>cURL:</td>
      <td><?php echo extension_loaded('curl') ? 'On' : 'Off'; ?></td>
      <td>On</td>
      <td style="text-align:center;"><?php echo extension_loaded('curl') ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
    <tr>
      <td>mCrypt:</td>
      <td><?php echo function_exists('mcrypt_encrypt') ? 'On' : 'Off'; ?></td>
      <td>On</td>
      <td style="text-align:center;"><?php echo function_exists('mcrypt_encrypt') ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
    <tr>
      <td>ZIP:</td>
      <td><?php echo extension_loaded('zlib') ? 'On' : 'Off'; ?></td>
      <td>On</td>
      <td style="text-align:center;"><?php echo extension_loaded('zlib') ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
    ...
    <tr>
      ...
      <td>On</td>
      <td style="text-align:center;"><?php echo extension_loaded('mbstring') ? '<img src="view/image/good.png" alt="Good" />' : '<img src="view/image/bad.png" alt="Bad" />'; ?></td>
    </tr>
    <?php } ?>
  </table>
  </fieldset>
  ...
  <table>
    <tr>
      <th style="text-align:left;"><b>Files</b></th>
  ...
  <table>
    <tr>
      <th style="text-align:left;"><b>Directories</b></th>
      <th style="text-align:left;"><b>Status</b></th>
    </tr>
    <tr>
