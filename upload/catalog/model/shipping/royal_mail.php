<?php
/* List of Royal Mail support Countries - SEE AT THE END OF FILE */
class ModelShippingRoyalMail extends Model {
	...
	public function getQuote($address) {
		...
		if ($status) {
			...
			$europe = array(
				'AL', 'AD', 'AM', 'AT', 'AZ', 'BY', 'BE', 'BG', 'XC', 'HR', 'CY', 'CZ',
				'DK', 'EE', 'FO', 'FI', 'FR', 'GE', 'DE', 'GI', 'GR', 'GL', 'HU', 'IS', 'IE', 'IT',
				'KZ', 'KV', 'KG', 'LV', 'LI', 'LT', 'LU', 'MK', 'MT', 'MD', 'CS', 'NL', 'NO',
				'PL', 'PT', 'RO', 'RU', 'SM', 'SK', 'SI', 'ES', 'SE', 'CH', 'TJ', 'TR', 'TM',
				'UA', 'UZ', 'VA'
			);

			$non_eu = array(
				'AL', 'AD', 'AM', 'AZ', 'BY', 'XC', 'FO', 'GE', 'GL', 'IS',
				'KZ', 'KV', 'KG', 'LI', 'MK', 'MD', 'CS', 'NO', 'RU', 'SM',
				'CH', 'TJ', 'TR', 'TM', 'UA', 'UZ', 'VA'
			);

			$zone_1 = array(
				'AF', 'NA', 'DZ', 'AO', 'AI', 'AG', 'AR', 'AW', 'XA', 'BS', 'BH', 'BD', 'BB',
				'BZ', 'BJ', 'BM', 'BT', 'BO', 'BX', 'BW', 'BR', 'VG', 'BN', 'BF', 'BI', 'KH',
				'CM', 'CA', 'CV', 'KY', 'CF', 'CE', 'TD', 'CL', 'CN', 'CO', 'KM', 'CD',
				'CG', 'CR', 'CU', 'CB', 'DJ', 'DM', 'DO', 'EC', 'EG', 'SV', 'GQ', 'ER', 'ET',
				'FK', 'GF', 'GA', 'GM', 'GH', 'GD', 'GP', 'GT', 'GN', 'GW', 'GY',
				'HT', 'HN', 'HK', 'IN', 'ID', 'IR', 'IQ', 'IL', 'CI', 'JM', 'JP', 'JO', 'KE', 'KW',
				'LB', 'LS', 'LR', 'LY', 'MG', 'YT', 'MW', 'MY', 'MV', 'ML', 'MQ', 'MR',
				'MU', 'XL', 'MX', 'MN', 'MS', 'MA', 'MZ', 'MM', 'NA', 'NP', 'NI', 'NE',
				'NG', 'KP', 'OM', 'PK', 'PA', 'PY', 'PE', 'PH', 'PR', 'QA', 'RE', 'RW',
				'ST', 'SA', 'SN', 'SC', 'SL', 'SO', 'ZA', 'KR', 'SD', 'LK', 'SX', 'SH',
				'KN', 'LC', 'SF', 'VC', 'SD', 'SR', 'SZ', 'SY', 'TW', 'TZ', 'TH', 'TP',
				'TG', 'TT', 'XT', 'TN', 'CP', 'TC', 'UG', 'AE', 'UY', 'US', 'VU', 'VE',
				'VN', 'WF', 'EH', 'YE', 'ZM', 'ZW'
			);

			$zone_2 = array(
				'AU', 'IO', 'CX', 'CK', 'FJ', 'PF', 'TF', 'KI', 'LA', 'MO', 'NR', 'NC',
				'NZ', 'NU', 'PW', 'PG', 'PN', 'SG', 'SB', 'TK', 'TO', 'TV', 'WS'
			);
			...
			$tracked_signed = array(
				'AD', 'AR', 'AT', 'BY', 'BE', 'BG', 'CA', 'KY', 'HR', 'CZ', 'DK', 'EC',
				'FI', 'FR', 'DE', 'GI', 'GR', 'HK', 'HU', 'IS', 'IT', 'JP', 'LI', 'LT', 'LU',
				'MT', 'NL', 'NZ', 'PL', 'PT', 'RO', 'SM', 'SG', 'SK', 'SI', 'KR', 'SE',
				'CH', 'TH', 'TT', 'US', 'VA'
			);
