<form action="https://secure.bluepay.com/interfaces/shpf" method="POST" id="bluepay_hosted_form_redirect">
  ...
  <div class="buttons">
    <div class="right">
      <input type="button" value="<?php echo $button_confirm; ?>" id="button-confirm" class="button" onclick="$('#bluepay_hosted_form_redirect').submit();" />
    </div>
  </div>
</form>