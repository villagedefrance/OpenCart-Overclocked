...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  <h2 style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_greeting; ?></h2>
  <p><?php echo $text_login; ?> <a href="<?php echo $login_link; ?>"><?php echo $login_link; ?></a></p>
  <p><b><?php echo $login; ?></b> <?php echo $login; ?></p>
  <p><b><?php echo $password; ?></b> <font color="red"><?php echo $password; ?></font></p>
