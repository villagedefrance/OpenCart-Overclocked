...
<div class="box">
  ...
  <div class="box-content <?php echo $content_shape; ?> <?php echo $content_color; ?>" style="padding:0px 0px 10px 0px; overflow:hidden;">
...
<?php } else { ?>
<div class="<?php echo $content_shape; ?> <?php echo $content_color; ?>" style="margin-bottom:20px; padding:10px 0px; overflow:hidden;">
  <div id="banner<?php echo $module; ?>" class="banner" style="padding:0px;">
    <?php foreach ($banners as $banner) { ?>
      <?php if ($banner['link']) { ?>
        <div><a href="<?php echo $banner['link']; ?>"><img src="<?php echo $banner['image']; ?>" alt="<?php echo $banner['title']; ?>" title="<?php echo $banner['title']; ?>" /></a></div>
