...
<div id="content"><?php echo $content_top; ?>
	...
	<tbody>
		...
		<tr>
			...
			<td class="right"><a href="<?php echo $product['return']; ?>"><img src="catalog/view/theme/<?php echo $template; ?>/image/return.png" alt="<?php echo $button_return; ?>" title="<?php echo $button_return; ?>" /></a></td>
		</tr>
		<?php } ?>
