...
class ControllerCheckoutExpressShippingMethod extends Controller {
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout_express/shipping_method.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout_express/shipping_method.tpl';
		} else {
			$this->template = 'default/template/checkout_express/shipping_method.tpl';
		}
