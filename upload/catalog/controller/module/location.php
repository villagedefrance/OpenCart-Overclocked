	...
	public function info() {
		...
		if ($location_info) {
			...
			if ($location_info['latitude'] && $location_info['longitude']) {
				$output .= '  <p style="margin-left:20px;"><img src="catalog/view/theme/' . $template . '/image/location/signal.png" alt="" />&nbsp;&nbsp; ' . html_entity_decode($location_info['latitude'], ENT_QUOTES, 'UTF-8') . '&deg; N &nbsp;&nbsp;<b>|</b>&nbsp;&nbsp; ' . html_entity_decode($location_info['longitude'], ENT_QUOTES, 'UTF-8') . '&deg; E</p>' . "\n";
			}
			$output .= '  </body>' . "\n";
			$output .= '</html>' . "\n";
