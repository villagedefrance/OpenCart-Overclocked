...
class ControllerModuleHtml extends Controller {
	...
	protected function index($setting) {
		...
		for ($i = 1; $i <= 10; $i++) {
			...
			$this->data['header_color' . $i] = ($header_color) ? $header_color : 'white';
			$this->data['header_shape' . $i] = ($header_shape) ? $header_shape : 'rounded-3';
			$this->data['content_color' . $i] = ($content_color) ? $content_color : 'white';
			$this->data['content_shape' . $i] = ($content_shape) ? $content_shape : 'rounded-3';
