...
class PHPExcel_Writer_Excel5 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter {
	...
	public function save($pFilename = null) {
		...
		// add 15 identical cell style Xfs for now, we use the first cellXf instead of cellStyleXf
		...
		// Write the worksheet streams before the global workbook stream, because the byte sizes of these are needed in the global workbook stream
	...
	private function _writeDocumentSummaryInformation() {
		...
		$dataSection[] = array('summary' => array('pack' => 'V', 'data' => 0x01), 'offset' => array('pack' => 'V'), 'type' => array('pack' => 'V', 'data' => 0x02), 'data' => array('data' => 1252));
