...
class PHPExcel_Calculation {
	...
	public function calculateFormula($formula, $cellID = null, PHPExcel_Cell $pCell = null) {
		...
		//	Disable calculation cacheing because it only applies to cell calculations, not straight formulas
	...
	private function _parseFormula($formula, PHPExcel_Cell $pCell = null) {
		...
		$expectingOperator = false;	//	We use this test in syntax-checking the expression to determine when a - is a negation or + is a positive operator rather than an operation
		$expectingOperand = false;	//	We use this test in syntax-checking the expression to determine whether an operand should be null in a function call
		...
		while(true) {
			...
			if ($opCharacter == '-' && !$expectingOperator) {				//	Is it a negation instead of a minus?
				...
				//	If we've a comma when we're expecting an operand, then what we actually have is a null operand, so push a null onto the stack
			...
			if ($index == strlen($formula)) {
				//	Did we end with an operator?. Only valid for the % unary operator
