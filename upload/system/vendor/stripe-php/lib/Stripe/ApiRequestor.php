...
class Stripe_ApiRequestor {
	...
	*
	* @return array An array whose first element is the response and second element is the API key used to make the request.
	*/
	...
	* @throws Stripe_AuthenticationError if the error is caused by a lack of permissions.
	* @throws Stripe_CardError if the error is the error code is 402 (payment required)
